...
btnClose = pygame.transform.scale(pygame.image.load("assets/img/flappyBirdQuitButton.png"), (100, 50))
btncRect = btnClose.get_rect(center=(200, 545))
    ...
    for event in pygame.event.get():
        ...
        if btnRect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0]:
                ...
                Score = 0
        posC = pygame.mouse.get_pos()
        if btncRect.collidepoint(posC):
            if pygame.mouse.get_pressed()[0]:
                pygame.quit()
                sys.exit()
